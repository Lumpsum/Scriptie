...
json_file = open('./Architecture/model.json', 'r')
...
filepath = "./Weights/ModelCrop/weights-{epoch:02d}-{val_acc:.2f}.hdf5"
...
tensorboard = TensorBoard(log_dir='./logs/ModelCrop1', write_graph=True, write_images=True, batch_size=batchSize)
