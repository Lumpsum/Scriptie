...
json_file = open('./Architecture/ResNetOutputs.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("./Weights/ResNetOutputs.h5")
...
filepath = "./Weights/ResNetOutputs/weights-{epoch:02d}-{val_acc:.2f}.hdf5"
...
tensorboard = TensorBoard(log_dir='./logs/ResNetOutputs', write_graph=True, write_images=True, batch_size=batchSize, histogram_freq=1)
