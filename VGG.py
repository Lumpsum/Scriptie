...
loaded_model.load_weights("./Weights/BodyCrop/weights-28-5.19.hdf5")
...
for x in os.listdir('./Weights/BodyCrop2/'):
  loaded_model = model_from_json(loaded_model_json)
  loaded_model.load_weights('./Weights/BodyCrop2/'+x)
  ...
  scores[x + 'Body2'] = {'build':ap1, 'eye':ap2, 'hair':ap3, 'race':ap4, 'map':mean}
